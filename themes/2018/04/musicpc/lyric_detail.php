	...
	<div class="row row_wrapper">
		<div class="col-md-9">
			...
			<div class="d-flex align-items-center justify-content-between mb-3 box1">
				<h1 class="title">Anh Đã Quen Với Cô Đơn (Single) - <span>Rhymastic</span></h1>
				<span class="d-flex align-items-center listen"><i class="material-icons">headset</i> 1.689 lượt nghe</span>
			</div>
			...
			<div class="row">
				<div class="col-md-4">
					<div class="card card-details">
						<img src="https://i.scdn.co/image/5570996211d2ef04e38deb3824fa3f443666d089" alt="" class="card-img-top">
						<div class="card-body">
							<h4 class="card-title">Anh Đã Quen Với Cô Đơn (Single)</h4>
							<ul class="list-unstyled">
								<li><span>Ca sĩ:</span> JustaTee</li>
								<li><span>Sáng tác:</span> JustaTee</li>
								<li><span>Album:</span> Đã Lỡ Yêu Em Nhiều (Single)</li>
				...
				<div class="col-md-8">
					<div class="d-flex justify-content-between mb-3">
						<div class="title2">
							Đóng góp: <span class="author">Frances Turner</span>
						</div>
						<div>
