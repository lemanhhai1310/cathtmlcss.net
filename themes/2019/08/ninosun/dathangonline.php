<div class="hotlinee fr" id="fixx_2">
    <div class="svg_hotline">
        <svg x="0px" y="0px" width="25px" height="25px" viewBox="0 0 411.595 411.595" style="enable-background:new 0 0 411.595 411.595;" xml:space="preserve">
            <g>
                <g>
                    <g>
    ...
    <div class="text_hotline">
        <span>
            ...
            <br>
            <a href="tel:0886 238 238" title="Hotline: 0886 238 238">0886 238 238</a>
        </span>
    </div>
</div>
<script>
    function updateTransition() {
        ...
        el = $('.hotlinee').attr('id');
        if (el == 'fixx') {
            $('.hotlinee').attr('id','fixx_2')

        } else {
            $('.hotlinee').attr('id','fixx')
        }

    }
    setInterval(updateTransition, 2000);
</script>