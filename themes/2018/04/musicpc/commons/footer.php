...
<div class="box_show_add_playlist card" id="answer-12878316">
	<div class="card-body d-flex flex-column">
		<button type="button" class="close" data-dismiss="modal" aria-label="Close">
        	<i class="material-icons">close</i>
        </button>
		<h5 class="card-title">Thêm bài hát này vào danh sách Playlist</h5>
		<div class="box_show_playlist_popup mb-2">
			<div class="list-group">
				<a href="#" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
					<span>Bài hát yêu thích (0)</span>
					<time datetime="2011-01-12">23/04/2018</time>
				</a>
				<a href="#" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
					<span>Lady (Single) (2)</span>
					<time datetime="2011-01-12">chiều hôm qua</time>
				</a>
				<a href="#" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
					<span>nhạc hay (1)</span>
					<time datetime="2011-01-12">23/04/2018</time>
				</a>
				<a href="#" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
					<span>Đừng Nghĩ Mình Là Duy Nhất (1)</span>
					<time datetime="2011-01-12">23/04/2018</time>
				</a>
				<a href="#" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
					<span>Bài hát yêu thích (0)</span>
