...
function initializeClock(n) {
    var t = document.getElementById(n), i = setInterval(function () {
...
function getTimeRemaining(n) {
    var t = Date.parse(new Date(n)) - Date.parse(new Date), i = Math.floor(t / 1e3 % 60), r = Math.floor(t / 6e4 % 60),
        u = Math.floor(t / 36e5 % 24), f = Math.floor(t / 864e5);
...
function LoadCategoryStatistic() {
    $.ajax({
        ...
        cache: !0,
        success: function (n) {
            n != null && n != "" && ($(".viewallcat .mobile").html("Xem táº¥t cáº£ <b>" + n.phone + "<\/b> Ä‘iá»‡n thoáº¡i"), $(".viewallcat .tablet").html("Xem táº¥t cáº£ <b>" + n.tablet + "<\/b> tablet"), $(".viewallcat .laptop").html("Xem táº¥t cáº£ <b>" + n.laptop + "<\/b> laptop"), $(".viewallcat .accessory").html("Xem táº¥t cáº£ <b>" + n.accessory + "<\/b> phá»¥ kiá»‡n"), $(".viewallcat .smartwatch").html("Xem táº¥t cáº£ <b>" + n.smartwatch + "<\/b> Ä‘á»“ng há»“ thĂ´ng minh"), $(".viewallcat .watch").html("Xem táº¥t cáº£ <b>" + n.watch + "<\/b> Ä‘á»“ng há»“ thá»i trang"), $(".viewallcat .accessoryApple").html("Xem táº¥t cáº£ <b>" + n.appleAccessory + "<\/b> phá»¥ kiá»‡n apple"))
        }
    })
}
...
!function (n, t) {
    ...
    if (t.getElementsByClassName) {
        var c, i, f = t.documentElement, e = n.Date, et = n.HTMLPictureElement, o = "addEventListener",
            r = "getAttribute", s = n[o], u = n.setTimeout, ot = n.requestAnimationFrame || u,
            d = n.requestIdleCallback, it = /^picture$/i, st = ["load", "error", "lazyincluded", "_lazyloaded"], p = {},
            ht = Array.prototype.forEach, l = function (n, t) {
                ...
                var r, f = 0, h = i.throttleDelay, t = i.ricTimeout, o = function () {
                    r = !1;
                    f = e.now();
                    n()
                }, s = d && t > 49 ? function () {
                ...
                return function (n) {
                    var i;
                    (n = !0 === n) && (t = 33);
                    r || (r = !0, i = h - (e.now() - f), i < 0 && (i = 0), n || i < 9 ? s() : u(s, i))
                }
            }, ut = function (n) {
        ...
        var ft = function () {
            var at, rt, gt, ft, ni, ti, ii, et, ot, st, lt, kt, vt, dt, ei = /^img$/i, oi = /^iframe$/i,
                si = "onscroll" in n && !/(gle|ing)bot/.test(navigator.userAgent), hi = 0, yt = 0, k = 0, d = -1,
                pt = function (n) {
                    k--;
                    ...
                    for (et -= i, lt += i, ot -= i, st += i; e && (r = r.offsetParent) && r != t.body && r != f;) (e = (h(r, "opacity") || 1) > 0) && "visible" != h(r, "overflow") && (u = r.getBoundingClientRect(), e = st > u.left && ot < u.right && lt > u.top - 1 && et < u.bottom + 1);
                    return e
                }, ri = function () {
                    var y, n, o, s, a, e, v, l, p, u = c.elements;
                    if ((ft = i.loadMode) && k < 8 && (y = u.length)) {
                        for (n = 0, d++, null == vt && (("expand" in i) || (i.expand = f.clientHeight > 500 && f.clientWidth > 500 ? 500 : 370), kt = i.expand, vt = kt * i.expFactor), yt < vt && k < 1 && d > 2 && ft > 2 && !t.hidden ? (yt = vt, d = 0) : yt = ft > 1 && d > 1 && k < 6 ? kt : hi; n < y; n++) if (u[n] && !u[n]._lazyRace) if (si) if ((l = u[n][r]("data-expand")) && (e = 1 * l) || (e = yt), p !== e && (ti = innerWidth + e * dt, ii = innerHeight + e, v = -1 * e, p = e), o = u[n].getBoundingClientRect(), (lt = o.bottom) >= v && (et = o.top) <= ii && (st = o.right) >= v * dt && (ot = o.left) <= ti && (lt || st || ot || et) && (i.loadHidden || "hidden" != h(u[n], "visibility")) && (rt && k < 3 && !l && (ft < 3 || d < 4) || ci(u[n], e))) {
                            if (wt(u[n]), a = !0, k > 9) break
                        } else !a && rt && !s && k < 4 && d < 4 && ft > 2 && (at[0] || i.preloadAfterLoad) && (at[0] || !l && (lt || st || ot || et || "auto" != u[n][r](i.sizesAttr))) && (s = at[0] || u[n]); else wt(u[n]);
                        s && !a && wt(s)
                    }
                    ...
                    var s, h, l, c, p, b;
                    (p = v(n, "lazybeforeunveil", t)).defaultPrevented || (e && (f ? w(n, i.autosizesClass) : n.setAttribute("sizes", e)), h = n[r](i.srcsetAttr), s = n[r](i.srcAttr), o && (l = n.parentNode, c = l && it.test(l.nodeName || "")), b = t.firesLoad || "src" in n && (h || s || c), p = {target: n}, b && (a(n, pt, !0), clearTimeout(gt), gt = u(pt, 2500), w(n, i.loadingClass), a(n, fi, !0)), c && ht.call(l.getElementsByTagName("source"), vi), h ? n.setAttribute("srcset", h) : s && !c && (oi.test(n.nodeName) ? ai(n, s) : n.src = s), o && (h || c) && nt(n, {src: s}));
                    ...
                    var f, t = ei.test(n.nodeName), e = t && (n[r](i.sizesAttr) || n[r]("sizes")), u = "auto" == e;
            ...
            return {
                ...
                }, checkElems: p, unveil: wt
            }
        }(), tt = function () {
            var n, f = b(function (n, t, i, r) {
                var f, u, e;
                if (n._lazysizesWidth = r, r += "px", n.setAttribute("sizes", r), it.test(t.nodeName || "")) for (f = t.getElementsByTagName("source"), u = 0, e = f.length; u < e; u++) f[u].setAttribute("sizes", r);
        ...
        return c = {cfg: i, autoSizer: tt, loader: ft, init: k, uP: nt, aC: w, rC: g, hC: l, fire: v, gW: rt, rAF: y}
    }
});
...
$(window).load(function () {
    ...
    function r(t) {
        var i = n.data("owlCarousel").owl.visibleItems, r = t, u = !1;
