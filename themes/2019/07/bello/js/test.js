...
function LoadCategoryStatistic() {
    $.ajax({
        ...
        cache: !0,
        success: function (n) {
            n != null && n != "" && ($(".viewallcat .mobile").html("Xem tất cả <b>" + n.phone + "<\/b> điện thoại"), $(".viewallcat .tablet").html("Xem tất cả <b>" + n.tablet + "<\/b> tablet"), $(".viewallcat .laptop").html("Xem tất cả <b>" + n.laptop + "<\/b> laptop"), $(".viewallcat .accessory").html("Xem tất cả <b>" + n.accessory + "<\/b> phụ kiện"), $(".viewallcat .smartwatch").html("Xem tất cả <b>" + n.smartwatch + "<\/b> đồng hồ thông minh"), $(".viewallcat .watch").html("Xem tất cả <b>" + n.watch + "<\/b> đồng hồ thời trang"), $(".viewallcat .accessoryApple").html("Xem tất cả <b>" + n.appleAccessory + "<\/b> phụ kiện apple"))
        }
    })
}
